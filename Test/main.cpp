 ...
 * Author: Khanh Nguyen
 *
 * Created on September 16, 2022, 3:15 PM
 */
...
int  srch1(const char [],const char []);//Search for 1 occurrence
...
int  srch1(const char sntnce[],const char pattern[])
{
